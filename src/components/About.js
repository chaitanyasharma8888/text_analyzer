...
//         </div>
//         <div className="btn">
//             <button typ="button" className="btn btn-primary my-3" onClick={toggleHandle}>{btnText}</button>
//         </div>
//     </>)
// }
  ...
  return (
    <div className="container" style={myStyle}>
        <h2>Heading</h2>
                ...
                <div>
                <button type="button" className="btn btn-primary my-2 mx-2" onClick={toggleStyle}>{myText}</button>
                </div>
